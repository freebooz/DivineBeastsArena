...
#include "DBAGameplayAbility_Tiger_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API UDBAGameplayAbility_Tiger_Passive : public UDBAZodiacAbilityBase
{
	GENERATED_BODY()

public:
	UDBAGameplayAbility_Tiger_Passive()
	{
		// 技能配置
