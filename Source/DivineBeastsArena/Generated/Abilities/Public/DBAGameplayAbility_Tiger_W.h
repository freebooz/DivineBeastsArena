...
#include "DBAGameplayAbility_Tiger_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API UDBAGameplayAbility_Tiger_W : public UDBAElementAbilityBase
{
	GENERATED_BODY()

public:
	UDBAGameplayAbility_Tiger_W()
	{
		// 技能配置
