...
#include "DBAGameplayAbility_Dragon_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API UDBAGameplayAbility_Dragon_W : public UDBAElementAbilityBase
{
	GENERATED_BODY()

public:
	UDBAGameplayAbility_Dragon_W()
	{
		// 技能配置
