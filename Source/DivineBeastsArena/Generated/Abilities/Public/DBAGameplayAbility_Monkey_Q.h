...
#include "DBAGameplayAbility_Monkey_Q.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API UDBAGameplayAbility_Monkey_Q : public UDBAElementAbilityBase
{
	GENERATED_BODY()

public:
	UDBAGameplayAbility_Monkey_Q()
	{
		// 技能配置
