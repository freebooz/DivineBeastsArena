...
#include "DBA/VFX/Components/DBAZodiacVFXComponent_Rat.h"
...
void UDBAZodiacVFXComponent_Rat::PlayHitVFX(AActor* Attacker)
{
	if (HitVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayMoveVFX(const FVector& Direction)
{
	if (MoveVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayDeathVFX()
{
	if (DeathVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayRespawnVFX()
{
...
void UDBAZodiacVFXComponent_Rat::PlayHitSFX()
{
	if (HitSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayMoveSFX()
{
	if (MoveSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayDeathSFX()
{
	if (DeathSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayHitAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayMoveAnimation(float Speed)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Rat::PlayDeathAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Rat::PlaySkillAnimation(FName SkillId)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
UAnimBlueprint* UDBAZodiacVFXComponent_Rat::GetAnimBlueprint() const
{
