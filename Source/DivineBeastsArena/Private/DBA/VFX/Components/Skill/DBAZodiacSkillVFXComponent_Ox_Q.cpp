...
#include "DBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Ox_Q.h"
#include "Kismet/GameplayStatics.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Ox_Q::UDBAZodiacSkillVFXComponent_Ox_Q()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Ox_Q::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Ox_Q::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
