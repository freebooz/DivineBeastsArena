...
#include "Combat/Projectiles/DBAProjectile_Snake_Q.h"
#include "Components/SphereComponent.h"

ADBAProjectile_Snake_Q::ADBAProjectile_Snake_Q()
{
	// 设置投射物属性
	Speed = 1200.0f;
	Radius = 30.0f;
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Snake/P_Snake_Q_Projectile.P_Snake_Q_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Snake/P_Snake_Q_Impact.P_Snake_Q_Impact"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> FlySFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Snake/S_Snake_Q_Fly.S_Snake_Q_Fly"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> ImpactSFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Snake/S_Snake_Q_Impact.S_Snake_Q_Impact"));
...
void ADBAProjectile_Snake_Q::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Snake_Q::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
