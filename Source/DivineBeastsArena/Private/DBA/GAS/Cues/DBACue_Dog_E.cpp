...
void UDBACue_Dog_E::LoadSkillData()
{
	// 从 DataTable 加载技能数据
...
bool UDBACue_Dog_E::OnExecuteGameplayCue(AActor* Target, FGameplayCueParameters& Parameters)
{
	// 获取技能数据
...
void UDBACue_Dog_E::OnActiveGameplayCue(AActor* Target, FGameplayCueParameters& Parameters)
{
	// 获取技能数据，检查是否有引导特效
	FDBASkillDataRow* SkillData = nullptr;
	UDataTable* SkillTable = LoadObject<UDataTable>(nullptr, TEXT("DataTable'/Game/Data/Skills/SkillDataTable.SkillDataTable'"));
...
void UDBACue_Dog_E::OnRemoveGameplayCue(AActor* Target, FGameplayCueParameters& Parameters)
{
