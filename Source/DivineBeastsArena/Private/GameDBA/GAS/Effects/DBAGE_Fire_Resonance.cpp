...
// GameplayEffect - 火共鸣元素共鸣

#include "GameDBA/GAS/Effects/DBAGE_Fire_Resonance.h"
...
UDBAGE_Fire_Resonance::UDBAGE_Fire_Resonance()
{
	...
	if (ResonanceTable)
	{
		static const FString ContextString = TEXT("DBAGE_Fire_Resonance");
		FDBADBElemenetResonanceRow* ResonanceRow = ResonanceTable->FindRow<FDBADBElemenetResonanceRow>(FName(TEXT("Fire")), ContextString, false);
		if (ResonanceRow)
		{
			// 控制时间加成
