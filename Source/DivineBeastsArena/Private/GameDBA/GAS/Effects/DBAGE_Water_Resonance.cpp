...
// GameplayEffect - 水共鸣元素共鸣

#include "GameDBA/GAS/Effects/DBAGE_Water_Resonance.h"
...
UDBAGE_Water_Resonance::UDBAGE_Water_Resonance()
{
	...
	if (ResonanceTable)
	{
		...
		FDBADBElemenetResonanceRow* ResonanceRow = ResonanceTable->FindRow<FDBADBElemenetResonanceRow>(FName(TEXT("Water")), ContextString, false);
		if (ResonanceRow)
		{
			// 控制时间加成
