...
{
	UE_LOG(LogDBAAbility, Log, TEXT("UDBAZodiacUltimateAbility_Generic::ActivateAbility - UltimateSkillID: %s"), *UltimateSkillID.ToString());
...
void UDBAZodiacUltimateAbility_Generic::EndAbility(
	...
	bool bWasCancelled)
{
	UE_LOG(LogDBAAbility, Log, TEXT("UDBAZodiacUltimateAbility_Generic::EndAbility - UltimateSkillID: %s, bWasCancelled: %d"), *UltimateSkillID.ToString(), bWasCancelled);
