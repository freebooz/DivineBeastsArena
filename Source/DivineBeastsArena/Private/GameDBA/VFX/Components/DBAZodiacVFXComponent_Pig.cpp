...
// VFX/SFX 鎸傝浇缁勪欢 - 绂忓渤鐏电尓

#include "GameDBA/VFX/Components/DBAZodiacVFXComponent_Pig.h"
...
UDBAZodiacVFXComponent_Pig::UDBAZodiacVFXComponent_Pig()
{
...
void UDBAZodiacVFXComponent_Pig::LoadDefaultAssets()
{
...
void UDBAZodiacVFXComponent_Pig::PlayAttackVFX(AActor* Target)
{
...
void UDBAZodiacVFXComponent_Pig::PlayHitVFX(AActor* Attacker)
{
	if (HitVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayMoveVFX(const FVector& Direction)
{
	if (MoveVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayDeathVFX()
{
	if (DeathVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayRespawnVFX()
{
...
void UDBAZodiacVFXComponent_Pig::PlayAttackSFX()
{
...
void UDBAZodiacVFXComponent_Pig::PlayHitSFX()
{
	if (HitSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayMoveSFX()
{
	if (MoveSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayDeathSFX()
{
	if (DeathSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Pig::PlaySkillSFX(FName SkillId)
{
...
void UDBAZodiacVFXComponent_Pig::PlayAttackAnimation()
{
...
void UDBAZodiacVFXComponent_Pig::PlayHitAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayMoveAnimation(float Speed)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Pig::PlayDeathAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Pig::PlaySkillAnimation(FName SkillId)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
UAnimBlueprint* UDBAZodiacVFXComponent_Pig::GetAnimBlueprint() const
{
