...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 瑁傞铏庡悰琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Tiger_Passive.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Tiger_Passive::UDBAZodiacSkillVFXComponent_Tiger_Passive()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Tiger_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
