...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鐜勮姳鐏佃泧缁堟瀬鎶€鑳?
#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Snake_R.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Snake_R::UDBAZodiacSkillVFXComponent_Snake_R()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Snake_R::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Snake_R::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
