...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 浜戝贰榫欏悰鎶€鑳絈

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dragon_Q.h"
...
void UDBAZodiacSkillVFXComponent_Dragon_Q::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
