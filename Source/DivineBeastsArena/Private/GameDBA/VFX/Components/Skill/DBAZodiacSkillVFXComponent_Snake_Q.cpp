...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鐜勮姳鐏佃泧鎶€鑳絈

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Snake_Q.h"
...
void UDBAZodiacSkillVFXComponent_Snake_Q::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
