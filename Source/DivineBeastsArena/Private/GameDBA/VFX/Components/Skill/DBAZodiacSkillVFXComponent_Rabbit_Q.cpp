...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鏈堝崕鐏靛厰鎶€鑳絈

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Rabbit_Q.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Rabbit_Q::UDBAZodiacSkillVFXComponent_Rabbit_Q()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rabbit_Q::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
