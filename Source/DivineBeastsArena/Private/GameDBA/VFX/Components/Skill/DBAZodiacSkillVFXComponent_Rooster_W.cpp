...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鏇滈福绁為浮鎶€鑳絎

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Rooster_W.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Rooster_W::UDBAZodiacSkillVFXComponent_Rooster_W()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Rooster_W::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rooster_W::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
