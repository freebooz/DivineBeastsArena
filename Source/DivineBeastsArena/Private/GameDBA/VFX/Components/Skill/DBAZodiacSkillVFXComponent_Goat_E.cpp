...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鐏垫辰浠欑緤鎶€鑳紼

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Goat_E.h"
...
void UDBAZodiacSkillVFXComponent_Goat_E::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
