...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 闀囧渤绁炵墰鎶€鑳絎

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Ox_W.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Ox_W::UDBAZodiacSkillVFXComponent_Ox_W()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Ox_W::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Ox_W::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
