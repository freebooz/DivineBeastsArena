...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 闀囬瓌鐏电姮鎶€鑳絈

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dog_Q.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Dog_Q::UDBAZodiacSkillVFXComponent_Dog_Q()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Dog_Q::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dog_Q::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
