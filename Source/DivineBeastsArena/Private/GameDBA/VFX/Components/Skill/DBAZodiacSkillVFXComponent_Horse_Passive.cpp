...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 韪忛澶╅┕琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Horse_Passive.h"
...
void UDBAZodiacSkillVFXComponent_Horse_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
