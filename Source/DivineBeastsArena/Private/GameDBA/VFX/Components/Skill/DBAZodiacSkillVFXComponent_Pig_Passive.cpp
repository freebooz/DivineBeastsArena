...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 绂忓渤鐏电尓琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Pig_Passive.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Pig_Passive::UDBAZodiacSkillVFXComponent_Pig_Passive()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Pig_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
