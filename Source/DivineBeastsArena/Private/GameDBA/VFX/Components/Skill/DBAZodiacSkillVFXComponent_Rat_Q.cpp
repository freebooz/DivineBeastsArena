...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 澶滈殣鐏甸紶鎶€鑳絈

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Rat_Q.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Rat_Q::UDBAZodiacSkillVFXComponent_Rat_Q()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Rat_Q::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rat_Q::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
