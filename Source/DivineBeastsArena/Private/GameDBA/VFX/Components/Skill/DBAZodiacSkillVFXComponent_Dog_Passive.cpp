...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 闀囬瓌鐏电姮琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dog_Passive.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Dog_Passive::UDBAZodiacSkillVFXComponent_Dog_Passive()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dog_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
