...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 浜戝贰榫欏悰鎶€鑳絎

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dragon_W.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Dragon_W::UDBAZodiacSkillVFXComponent_Dragon_W()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Dragon_W::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dragon_W::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
