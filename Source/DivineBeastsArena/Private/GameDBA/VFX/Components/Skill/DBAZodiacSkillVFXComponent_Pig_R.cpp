...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 绂忓渤鐏电尓缁堟瀬鎶€鑳?
#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Pig_R.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Pig_R::UDBAZodiacSkillVFXComponent_Pig_R()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Pig_R::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Pig_R::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
