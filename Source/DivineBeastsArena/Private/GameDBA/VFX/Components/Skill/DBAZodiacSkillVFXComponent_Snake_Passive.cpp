...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 鐜勮姳鐏佃泧琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Snake_Passive.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Snake_Passive::UDBAZodiacSkillVFXComponent_Snake_Passive()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Snake_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
