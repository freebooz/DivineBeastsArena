...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 澶滈殣鐏甸紶鎶€鑳紼

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Rat_E.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Rat_E::UDBAZodiacSkillVFXComponent_Rat_E()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Rat_E::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Rat_E::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
