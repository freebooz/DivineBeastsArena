...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 浜戝贰榫欏悰琚姩

#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dragon_Passive.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Dragon_Passive::UDBAZodiacSkillVFXComponent_Dragon_Passive()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Dragon_Passive::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
