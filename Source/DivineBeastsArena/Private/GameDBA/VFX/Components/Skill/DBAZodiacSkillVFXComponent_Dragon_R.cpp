...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 浜戝贰榫欏悰缁堟瀬鎶€鑳?
#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Dragon_R.h"
...
void UDBAZodiacSkillVFXComponent_Dragon_R::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
