...
// 鎶€鑳絍FX/SFX鎸傝浇缁勪欢 - 骞讳簯鐏电尶缁堟瀬鎶€鑳?
#include "GameDBA/VFX/Components/Skill/DBAZodiacSkillVFXComponent_Monkey_R.h"
#include "Kismet/GameplayStatics.h"
#include "Particles/ParticleSystem.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacSkillVFXComponent_Monkey_R::UDBAZodiacSkillVFXComponent_Monkey_R()
{
	PrimaryComponentTick.bCanEverTick = true;
}

void UDBAZodiacSkillVFXComponent_Monkey_R::PlayCastingVFX(AActor* Target)
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayImpactVFX(AActor* HitTarget)
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayProjectileVFX(FVector Start, FVector End)
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayAOEVFX(FVector Center, float Radius)
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::StopChannelVFX()
{
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayProjectileSFX()
{
	if (USoundBase* SFX = ProjectileSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayImpactSFX()
{
	if (USoundBase* SFX = ImpactSFX.LoadSynchronous())
	{
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), SFX, GetOwner()->GetActorLocation());
...
void UDBAZodiacSkillVFXComponent_Monkey_R::PlayCastingSFX()
{
	if (USoundBase* SFX = CastingSFX.LoadSynchronous())
	{
