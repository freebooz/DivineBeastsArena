...
#include "GameDBA/VFX/Components/DBAZodiacVFXComponent_Tiger.h"
#include "Kismet/GameplayStatics.h"
#include "Components/SkeletalMeshComponent.h"
#include "Engine/World.h"

UDBAZodiacVFXComponent_Tiger::UDBAZodiacVFXComponent_Tiger()
{
...
void UDBAZodiacVFXComponent_Tiger::LoadDefaultAssets()
{
...
void UDBAZodiacVFXComponent_Tiger::PlayAttackVFX(AActor* Target)
{
...
void UDBAZodiacVFXComponent_Tiger::PlayHitVFX(AActor* Attacker)
{
	if (HitVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayMoveVFX(const FVector& Direction)
{
	if (MoveVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayDeathVFX()
{
	if (DeathVFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayRespawnVFX()
{
...
void UDBAZodiacVFXComponent_Tiger::PlayAttackSFX()
{
...
void UDBAZodiacVFXComponent_Tiger::PlayHitSFX()
{
	if (HitSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayMoveSFX()
{
	if (MoveSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayDeathSFX()
{
	if (DeathSFX.IsValid())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlaySkillSFX(FName SkillId)
{
...
void UDBAZodiacVFXComponent_Tiger::PlayAttackAnimation()
{
...
void UDBAZodiacVFXComponent_Tiger::PlayHitAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayMoveAnimation(float Speed)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlayDeathAnimation()
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
void UDBAZodiacVFXComponent_Tiger::PlaySkillAnimation(FName SkillId)
{
	if (USkeletalMeshComponent* Mesh = GetOwner()->FindComponentByClass<USkeletalMeshComponent>())
	{
...
UAnimBlueprint* UDBAZodiacVFXComponent_Tiger::GetAnimBlueprint() const
{
