...
ADBAProjectile_Rooster_E::ADBAProjectile_Rooster_E()
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rooster/P_Rooster_E_Projectile.P_Rooster_E_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rooster/P_Rooster_E_Impact.P_Rooster_E_Impact"));
...
void ADBAProjectile_Rooster_E::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Rooster_E::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
