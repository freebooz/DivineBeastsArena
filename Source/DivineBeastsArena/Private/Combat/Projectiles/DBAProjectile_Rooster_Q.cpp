...
#include "Combat/Projectiles/DBAProjectile_Rooster_Q.h"
#include "Components/SphereComponent.h"

ADBAProjectile_Rooster_Q::ADBAProjectile_Rooster_Q()
{
	// 设置投射物属性
	Speed = 1200.0f;
	Radius = 30.0f;
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rooster/P_Rooster_Q_Projectile.P_Rooster_Q_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rooster/P_Rooster_Q_Impact.P_Rooster_Q_Impact"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> FlySFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Rooster/S_Rooster_Q_Fly.S_Rooster_Q_Fly"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> ImpactSFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Rooster/S_Rooster_Q_Impact.S_Rooster_Q_Impact"));
...
void ADBAProjectile_Rooster_Q::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Rooster_Q::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
