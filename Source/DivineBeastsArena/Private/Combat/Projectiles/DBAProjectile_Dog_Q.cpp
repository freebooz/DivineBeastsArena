...
#include "Combat/Projectiles/DBAProjectile_Dog_Q.h"
#include "Components/SphereComponent.h"

ADBAProjectile_Dog_Q::ADBAProjectile_Dog_Q()
{
	// 设置投射物属性
	Speed = 1200.0f;
	Radius = 30.0f;
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Dog/P_Dog_Q_Projectile.P_Dog_Q_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Dog/P_Dog_Q_Impact.P_Dog_Q_Impact"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> FlySFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Dog/S_Dog_Q_Fly.S_Dog_Q_Fly"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> ImpactSFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Dog/S_Dog_Q_Impact.S_Dog_Q_Impact"));
...
void ADBAProjectile_Dog_Q::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Dog_Q::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
