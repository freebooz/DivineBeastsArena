...
ADBAProjectile_Rabbit_E::ADBAProjectile_Rabbit_E()
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rabbit/P_Rabbit_E_Projectile.P_Rabbit_E_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Rabbit/P_Rabbit_E_Impact.P_Rabbit_E_Impact"));
...
void ADBAProjectile_Rabbit_E::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Rabbit_E::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
