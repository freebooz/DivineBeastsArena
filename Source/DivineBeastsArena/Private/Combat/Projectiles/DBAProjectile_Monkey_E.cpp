...
#include "Combat/Projectiles/DBAProjectile_Monkey_E.h"
#include "Components/SphereComponent.h"

ADBAProjectile_Monkey_E::ADBAProjectile_Monkey_E()
{
	// 设置投射物属性
	Speed = 1200.0f;
	Radius = 30.0f;
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Monkey/P_Monkey_E_Projectile.P_Monkey_E_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Monkey/P_Monkey_E_Impact.P_Monkey_E_Impact"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> FlySFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Monkey/S_Monkey_E_Fly.S_Monkey_E_Fly"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> ImpactSFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Monkey/S_Monkey_E_Impact.S_Monkey_E_Impact"));
...
void ADBAProjectile_Monkey_E::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Monkey_E::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
