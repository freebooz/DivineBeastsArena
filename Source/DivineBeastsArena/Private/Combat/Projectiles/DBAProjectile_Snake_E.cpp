...
#include "Combat/Projectiles/DBAProjectile_Snake_E.h"
#include "Components/SphereComponent.h"

ADBAProjectile_Snake_E::ADBAProjectile_Snake_E()
{
	// 设置投射物属性
	Speed = 1200.0f;
	Radius = 30.0f;
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ProjectileVFXFinder(
		TEXT("/Game/VFX/Projectiles/Snake/P_Snake_E_Projectile.P_Snake_E_Projectile"));
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> ImpactVFXFinder(
		TEXT("/Game/VFX/Projectiles/Snake/P_Snake_E_Impact.P_Snake_E_Impact"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> FlySFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Snake/S_Snake_E_Fly.S_Snake_E_Fly"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> ImpactSFXFinder(
		TEXT("/Game/Audio/SFX/Projectiles/Snake/S_Snake_E_Impact.S_Snake_E_Impact"));
...
void ADBAProjectile_Snake_E::BeginPlay()
{
	Super::BeginPlay();
}

void ADBAProjectile_Snake_E::InitializeProjectile(
	FName InSkillId,
	AActor* InOwner,
	AActor* InTarget,
	float InDamage,
