...
public:
	...
	/** 播放攻击特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|VFX|福岳灵猪")
	...
	/** 播放攻击音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SFX|福岳灵猪")
	void PlayAttackSFX();
	...
	/** 播放攻击动画 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Animation|福岳灵猪")
	...
	/** 获取动画蓝图 */
	UFUNCTION(BlueprintPure, Category = "DBA|Animation|福岳灵猪")
...
protected:
	...
	/** 攻击特效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "VFX|福岳灵猪")
	...
	/** 攻击音效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SFX|福岳灵猪")
