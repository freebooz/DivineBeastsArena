...
#include "DBAZodiacSkillVFXComponent_Snake_W.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Snake_W
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Snake W"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Snake_W : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Snake_W();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|玄花灵蛇技能W")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|玄花灵蛇技能W")
	void PlayCastingSFX();
