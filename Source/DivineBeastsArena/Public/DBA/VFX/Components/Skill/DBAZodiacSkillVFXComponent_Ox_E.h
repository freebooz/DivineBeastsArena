...
#include "DBAZodiacSkillVFXComponent_Ox_E.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Ox_E
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Ox E"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Ox_E : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Ox_E();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|镇岳神牛技能E")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|镇岳神牛技能E")
	void PlayCastingSFX();
