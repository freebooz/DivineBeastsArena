...
#include "DBAZodiacSkillVFXComponent_Goat_Q.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Goat_Q
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Goat Q"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Goat_Q : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Goat_Q();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|灵泽仙羊技能Q")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|灵泽仙羊技能Q")
	void PlayCastingSFX();
