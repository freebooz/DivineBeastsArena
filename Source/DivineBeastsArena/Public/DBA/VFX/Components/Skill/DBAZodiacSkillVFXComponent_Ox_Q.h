...
#include "DBAZodiacSkillVFXComponent_Ox_Q.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Ox_Q
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Ox Q"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Ox_Q : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Ox_Q();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|镇岳神牛技能Q")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|镇岳神牛技能Q")
	void PlayCastingSFX();
