...
// 技能VFX/SFX挂载组件 - 镇魄灵犬终极技能

#pragma once

#include "CoreMinimal.h"
#include "Components/ActorComponent.h"
#include "DBAZodiacSkillVFXComponent_Dog_R.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Dog_R
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Dog R"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Dog_R : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Dog_R();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|镇魄灵犬终极技能")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|镇魄灵犬终极技能")
	void PlayCastingSFX();
