...
// 技能VFX/SFX挂载组件 - 踏风天驹技能W

#pragma once

#include "CoreMinimal.h"
#include "DBAZodiacSkillVFXComponent_Horse_W.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Horse_W
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Horse W"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Horse_W : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Horse_W();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|踏风天驹技能W")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|踏风天驹技能W")
	void PlayCastingSFX();
