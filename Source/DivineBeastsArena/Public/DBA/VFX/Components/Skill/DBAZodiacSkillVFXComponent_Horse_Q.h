...
#include "DBAZodiacSkillVFXComponent_Horse_Q.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Horse_Q
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Horse Q"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Horse_Q : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Horse_Q();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|踏风天驹技能Q")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|踏风天驹技能Q")
	void PlayCastingSFX();
