...
#include "DBAZodiacSkillVFXComponent_Rooster_Passive.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Rooster_Passive
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Rooster Passive"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Rooster_Passive : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Rooster_Passive();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|曜鸣神鸡被动")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|曜鸣神鸡被动")
	void PlayCastingSFX();
