...
#include "DBAZodiacSkillVFXComponent_Goat_E.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Goat_E
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Goat E"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Goat_E : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Goat_E();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|灵泽仙羊技能E")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|灵泽仙羊技能E")
	void PlayCastingSFX();
