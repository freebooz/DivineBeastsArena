...
#include "DBAZodiacSkillVFXComponent_Rabbit_Passive.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Rabbit_Passive
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Rabbit Passive"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Rabbit_Passive : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Rabbit_Passive();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|月华灵兔被动")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|月华灵兔被动")
	void PlayCastingSFX();
