...
#include "DBAZodiacSkillVFXComponent_Monkey_Passive.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Monkey_Passive
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Monkey Passive"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Monkey_Passive : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Monkey_Passive();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|幻云灵猿被动")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|幻云灵猿被动")
	void PlayCastingSFX();
