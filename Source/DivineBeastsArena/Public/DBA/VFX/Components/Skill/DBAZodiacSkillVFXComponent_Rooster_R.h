...
#include "DBAZodiacSkillVFXComponent_Rooster_R.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Rooster_R
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Rooster R"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Rooster_R : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Rooster_R();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|曜鸣神鸡终极技能")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|曜鸣神鸡终极技能")
	void PlayCastingSFX();
