...
#include "DBAZodiacSkillVFXComponent_Pig_Passive.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Pig_Passive
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Pig Passive"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Pig_Passive : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Pig_Passive();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|福岳灵猪被动")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|福岳灵猪被动")
	void PlayCastingSFX();
