...
/**
 * DBAZodiacSkillVFXComponent_Rooster_W
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Rooster W"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Rooster_W : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Rooster_W();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|曜鸣神鸡技能W")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|曜鸣神鸡技能W")
	void PlayCastingSFX();
