...
#include "DBAZodiacSkillVFXComponent_Goat_R.generated.h"
...
/**
 * DBAZodiacSkillVFXComponent_Goat_R
 * 技能VFX/SFX挂载组件
 * 负责管理技能的视觉和音效资源
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Skill VFX Goat R"))
class DIVINEBEASTSARENA_API UDBAZodiacSkillVFXComponent_Goat_R : public UActorComponent
{
	GENERATED_BODY()

public:
	UDBAZodiacSkillVFXComponent_Goat_R();

public:
	// ==================== 技能特效接口 ====================

	/** 播放施法特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillVFX|灵泽仙羊终极技能")
	...
	/** 播放施法音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SkillSFX|灵泽仙羊终极技能")
	void PlayCastingSFX();
