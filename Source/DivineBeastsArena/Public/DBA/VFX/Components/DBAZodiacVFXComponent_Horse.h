...
public:
	...
	/** 播放攻击特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|VFX|踏风天驹")
	...
	/** 播放攻击音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SFX|踏风天驹")
	void PlayAttackSFX();
	...
	/** 播放攻击动画 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Animation|踏风天驹")
	...
	/** 获取动画蓝图 */
	UFUNCTION(BlueprintPure, Category = "DBA|Animation|踏风天驹")
...
protected:
	...
	/** 攻击特效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "VFX|踏风天驹")
	...
	/** 攻击音效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SFX|踏风天驹")
