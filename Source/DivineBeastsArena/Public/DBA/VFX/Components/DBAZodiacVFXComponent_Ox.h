...
public:
	...
	/** 播放攻击特效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|VFX|镇岳神牛")
	...
	/** 播放攻击音效 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SFX|镇岳神牛")
	void PlayAttackSFX();
	...
	/** 播放攻击动画 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Animation|镇岳神牛")
	...
	/** 获取动画蓝图 */
	UFUNCTION(BlueprintPure, Category = "DBA|Animation|镇岳神牛")
...
protected:
	...
	/** 攻击特效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "VFX|镇岳神牛")
	...
	/** 攻击音效 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SFX|镇岳神牛")
