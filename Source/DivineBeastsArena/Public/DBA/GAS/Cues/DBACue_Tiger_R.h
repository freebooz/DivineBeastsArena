...
#include "DBACue_Tiger_R.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Tiger_R : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Tiger_R"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Tiger_R")); }
};
