...
#include "DBACue_Rabbit_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rabbit_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rabbit_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rabbit_W")); }
};
