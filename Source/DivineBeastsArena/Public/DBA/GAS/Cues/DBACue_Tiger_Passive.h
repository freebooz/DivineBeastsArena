...
#include "DBACue_Tiger_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Tiger_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Tiger_Passive();
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Tiger_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Tiger_Passive")); }
};
