...
#include "DBACue_Dog_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Dog_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Dog_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Dog_W")); }
};
