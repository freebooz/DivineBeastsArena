...
UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Dragon_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Dragon_Passive();
...
protected:
	...
	FName SkillId = FName(TEXT("Dragon_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Dragon_Passive")); }
};
