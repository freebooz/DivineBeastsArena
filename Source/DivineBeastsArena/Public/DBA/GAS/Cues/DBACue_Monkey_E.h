...
#include "DBACue_Monkey_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Monkey_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Monkey_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Monkey_E")); }
};
