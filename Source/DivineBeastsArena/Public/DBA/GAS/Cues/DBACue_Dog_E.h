...
#include "DBACue_Dog_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Dog_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Dog_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Dog_E")); }
};
