...
#include "DBACue_Rooster_R.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rooster_R : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rooster_R"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rooster_R")); }
};
