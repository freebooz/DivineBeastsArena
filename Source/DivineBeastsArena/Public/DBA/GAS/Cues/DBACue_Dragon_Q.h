...
#include "DBACue_Dragon_Q.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Dragon_Q : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Dragon_Q"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Dragon_Q")); }
};
