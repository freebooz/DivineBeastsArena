...
UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Horse_R : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Horse_R"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Horse_R")); }
};
