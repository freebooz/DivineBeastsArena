...
#include "DBACue_Ox_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Ox_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Ox_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Ox_W")); }
};
