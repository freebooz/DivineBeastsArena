...
#include "DBACue_Rabbit_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rabbit_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Rabbit_Passive();
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Rabbit_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rabbit_Passive")); }
};
