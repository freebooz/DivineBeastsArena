...
#include "DBACue_Ox_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Ox_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Ox_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Ox_E")); }
};
