...
#include "DBACue_Snake_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Snake_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Snake_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Snake_W")); }
};
