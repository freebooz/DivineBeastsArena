...
#include "DBACue_Rooster_Q.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rooster_Q : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rooster_Q"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rooster_Q")); }
};
