...
#include "DBACue_Rabbit_Q.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rabbit_Q : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rabbit_Q"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rabbit_Q")); }
};
