...
#include "DBACue_Dragon_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Dragon_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Dragon_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Dragon_W")); }
};
