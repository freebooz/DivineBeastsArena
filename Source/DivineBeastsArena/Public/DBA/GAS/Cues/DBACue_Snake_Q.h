...
#include "DBACue_Snake_Q.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Snake_Q : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Snake_Q"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Snake_Q")); }
};
