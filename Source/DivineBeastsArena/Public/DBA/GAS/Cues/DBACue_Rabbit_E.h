...
#include "DBACue_Rabbit_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rabbit_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rabbit_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rabbit_E")); }
};
