...
UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Ox_R : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Ox_R"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Ox_R")); }
};
