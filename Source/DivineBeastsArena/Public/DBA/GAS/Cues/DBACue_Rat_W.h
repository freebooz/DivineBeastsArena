...
#include "DBACue_Rat_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rat_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Rat_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rat_W")); }
};
