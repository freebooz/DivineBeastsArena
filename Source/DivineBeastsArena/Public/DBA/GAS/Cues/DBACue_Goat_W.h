...
#include "DBACue_Goat_W.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Goat_W : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Goat_W"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Goat_W")); }
};
