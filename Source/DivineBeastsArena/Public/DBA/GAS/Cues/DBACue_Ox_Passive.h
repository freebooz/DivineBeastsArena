...
#include "DBACue_Ox_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Ox_Passive : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Ox_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Ox_Passive")); }
};
