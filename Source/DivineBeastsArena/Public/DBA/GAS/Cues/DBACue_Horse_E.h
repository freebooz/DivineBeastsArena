...
#include "DBACue_Horse_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Horse_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Horse_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Horse_E")); }
};
