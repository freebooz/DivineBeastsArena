...
#include "DBACue_Pig_E.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Pig_E : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Pig_E"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Pig_E")); }
};
