...
#include "DBACue_Rooster_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rooster_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Rooster_Passive();
...
protected:
	...
	FName SkillId = FName(TEXT("Rooster_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rooster_Passive")); }
};
