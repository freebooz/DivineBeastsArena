...
#include "DBACue_Rat_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Rat_Passive : public ADBACue_Base
{
	GENERATED_BODY()
...
protected:
	...
	FName SkillId = FName(TEXT("Rat_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Rat_Passive")); }
};
