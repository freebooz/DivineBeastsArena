...
#include "DBACue_Snake_Passive.generated.h"

UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Snake_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Snake_Passive();
...
protected:
	...
	// 技能ID (用于查询数据)
	UPROPERTY(EditDefaultsOnly, Category = "Cue")
	FName SkillId = FName(TEXT("Snake_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Snake_Passive")); }
};
