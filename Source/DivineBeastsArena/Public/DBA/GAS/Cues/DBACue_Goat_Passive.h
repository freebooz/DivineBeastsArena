...
UCLASS()
class DIVINEBEASTSARENA_API ADBACue_Goat_Passive : public ADBACue_Base
{
	GENERATED_BODY()

public:
	ADBACue_Goat_Passive();
...
protected:
	...
	FName SkillId = FName(TEXT("Goat_Passive"));

protected:
	virtual FName GetSkillId() const override { return FName(TEXT("Goat_Passive")); }
};
