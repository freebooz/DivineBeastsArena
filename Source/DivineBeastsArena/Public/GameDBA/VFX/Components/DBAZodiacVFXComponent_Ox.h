...
#include "DBAZodiacVFXComponent_Ox.generated.h"
...
/**
 * UDBAZodiacVFXComponent_Ox
 * 鐢熻倴瑙掕壊 VFX/SFX 鎸傝浇缁勪欢
 * 璐熻矗绠＄悊闀囧渤绁炵墰鐨勮瑙夊拰闊虫晥璧勬簮
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Zodiac VFX Component Ox"))
class DIVINEBEASTSARENA_API UDBAZodiacVFXComponent_Ox : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	/** 鎾斁鏀诲嚮鐗规晥 */
	UFUNCTION(BlueprintCallable, Category = "DBA|VFX|闀囧渤绁炵墰")
	...
	/** 鎾斁鏀诲嚮闊虫晥 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SFX|闀囧渤绁炵墰")
	void PlayAttackSFX();
	...
	/** 鎾斁鏀诲嚮鍔ㄧ敾 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Animation|闀囧渤绁炵墰")
	...
	/** 鑾峰彇鍔ㄧ敾钃濆浘 */
	UFUNCTION(BlueprintPure, Category = "DBA|Animation|闀囧渤绁炵墰")
...
protected:
	...
	/** 鏀诲嚮鐗规晥 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "VFX|闀囧渤绁炵墰")
	...
	/** 鏀诲嚮闊虫晥 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SFX|闀囧渤绁炵墰")
	...
	/** 鍔ㄧ敾钃濆浘 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Animation|闀囧渤绁炵墰")
