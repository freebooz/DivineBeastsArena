...
#include "DBAZodiacVFXComponent_Horse.generated.h"
...
/**
 * UDBAZodiacVFXComponent_Horse
 * 鐢熻倴瑙掕壊 VFX/SFX 鎸傝浇缁勪欢
 * 璐熻矗绠＄悊韪忛澶╅┕鐨勮瑙夊拰闊虫晥璧勬簮
 */
UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "DBA Zodiac VFX Component Horse"))
class DIVINEBEASTSARENA_API UDBAZodiacVFXComponent_Horse : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	/** 鎾斁鏀诲嚮鐗规晥 */
	UFUNCTION(BlueprintCallable, Category = "DBA|VFX|韪忛澶╅┕")
	...
	/** 鎾斁鏀诲嚮闊虫晥 */
	UFUNCTION(BlueprintCallable, Category = "DBA|SFX|韪忛澶╅┕")
	void PlayAttackSFX();
	...
	/** 鎾斁鏀诲嚮鍔ㄧ敾 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Animation|韪忛澶╅┕")
	...
	/** 鑾峰彇鍔ㄧ敾钃濆浘 */
	UFUNCTION(BlueprintPure, Category = "DBA|Animation|韪忛澶╅┕")
...
protected:
	...
	/** 鏀诲嚮鐗规晥 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "VFX|韪忛澶╅┕")
	...
	/** 鏀诲嚮闊虫晥 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "SFX|韪忛澶╅┕")
	...
	/** 鍔ㄧ敾钃濆浘 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Animation|韪忛澶╅┕")
