...
namespace Game.Shared.Contracts.Inventory;
...
public record PlayerInventoryResponse(Guid PlayerId, IReadOnlyList<InventoryItemDto> Items);
...
public record GrantItemRequest(Guid PlayerId, string ItemId, long Quantity, string Reason, string? BizId);
public record DeductItemRequest(Guid PlayerId, string ItemId, long Quantity, string Reason, string? BizId);
