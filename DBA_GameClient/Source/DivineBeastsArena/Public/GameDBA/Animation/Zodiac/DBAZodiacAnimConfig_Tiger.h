...
#include "GameDBA/Animation/DBAAnimConfig.h"
#include "DBAZodiacAnimConfig_Tiger.generated.h"

/**
 * UDBAZodiacAnimConfig_Tiger
 * 裂风虎君动画配置
 * 定义裂风虎君角色特有的动画资源
 */
UCLASS(Blueprintable, BlueprintType)
class DIVINEBEASTSARENA_API UDBAZodiacAnimConfig_Tiger : public UDataAsset
{
	GENERATED_BODY()
