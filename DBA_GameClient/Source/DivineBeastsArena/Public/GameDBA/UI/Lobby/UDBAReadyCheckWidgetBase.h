...
class DIVINEBEASTSARENA_API UDBAReadyCheckWidgetBase : public UDBAMobaUserWidgetBase
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnReadyCheckCompletedNative, bool, bAccepted);
...
public:
	...
	FOnReadyCheckCompletedNative OnReadyCheckCompletedEvent;

protected:
	void CompleteReadyCheck(bool bAccepted);
