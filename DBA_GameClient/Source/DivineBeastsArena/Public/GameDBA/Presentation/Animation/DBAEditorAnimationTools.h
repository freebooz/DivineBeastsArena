...
public:
	...
	/** 从骨骼网格的参考骨架创建或复用项目内 Skeleton，并关联该网格。仅限 Editor 自动化使用。 */
	UFUNCTION(BlueprintCallable, Category = "DBA|Editor|Animation")
	static USkeleton* CreateOrUpdateSkeletonFromMesh(USkeletalMesh* SkeletalMesh, const FString& SkeletonPackagePath, const FString& SkeletonAssetName);
