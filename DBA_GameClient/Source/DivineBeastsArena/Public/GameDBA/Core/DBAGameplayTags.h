...
public:
	...
	mutable FGameplayTag GameplayCue_DBA_Skill_Cast;
	mutable FGameplayTag GameplayCue_DBA_Skill_Projectile;
	mutable FGameplayTag GameplayCue_DBA_Skill_Impact;
	mutable FGameplayTag GameplayCue_DBA_Skill_AOE;
	mutable FGameplayTag GameplayCue_DBA_Skill_Channel;
