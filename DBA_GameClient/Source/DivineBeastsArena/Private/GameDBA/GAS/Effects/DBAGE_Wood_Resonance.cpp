...
// GameplayEffect - 鏈ㄥ叡楦ｅ厓绱犲叡楦?
#include "GameDBA/GAS/Effects/DBAGE_Wood_Resonance.h"
...
UDBAGE_Wood_Resonance::UDBAGE_Wood_Resonance()
{
	...
	if (ResonanceTable)
	{
		...
		FDBAElementResonanceRow* ResonanceRow = ResonanceTable->FindRow<FDBAElementResonanceRow>(FName(TEXT("Wood")), ContextString, false);
		if (ResonanceRow)
		{
			// 鎺у埗鏃堕棿鍔犳垚
