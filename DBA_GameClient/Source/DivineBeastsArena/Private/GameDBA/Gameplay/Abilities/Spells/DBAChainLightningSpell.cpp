...
#include "GameDBA/Gameplay/Abilities/Damage/DBADamageCalculator.h"
...
ADBAChainLightningSpell::ADBAChainLightningSpell()
{
	...
	ArcVFXAsset = PresentationSettings->ChainLightningArcVFX;
	BranchVFXAsset = PresentationSettings->ChainLightningBranchVFX;
	ImpactVFXAsset = PresentationSettings->ChainLightningImpactVFX;
	CastSFXAsset = PresentationSettings->ChainLightningCastSFX;
	FlightSFXAsset = PresentationSettings->ChainLightningFlightSFX;
	ImpactSFXAsset = PresentationSettings->ChainLightningImpactSFX;
}
