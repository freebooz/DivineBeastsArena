...
ADBAHolyShieldSpell::ADBAHolyShieldSpell()
{
	...
	CastVFXAsset = PresentationSettings->HolyShieldCastVFX;
	BarrierVFXAsset = PresentationSettings->HolyShieldBarrierVFX;
	FlightVFXAsset = PresentationSettings->HolyShieldFlightVFX;
	ImpactVFXAsset = PresentationSettings->HolyShieldImpactVFX;
	CastSFXAsset = PresentationSettings->HolyShieldCastSFX;
	SustainSFXAsset = PresentationSettings->HolyShieldSustainSFX;
	ImpactSFXAsset = PresentationSettings->HolyShieldImpactSFX;
}
