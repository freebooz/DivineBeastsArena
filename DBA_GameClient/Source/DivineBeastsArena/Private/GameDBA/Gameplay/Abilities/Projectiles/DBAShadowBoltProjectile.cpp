...
#include "GameDBA/Gameplay/Abilities/Projectiles/DBAShadowBoltProjectile.h"
...
ADBAShadowBoltProjectile::ADBAShadowBoltProjectile()
{
	...
	{
		ShadowCore->SetStaticMesh(SphereMesh);
		ShadowHalo->SetStaticMesh(SphereMesh);
	}
	...
	ProjectileNiagaraVFXAsset = PresentationSettings->ShadowBoltProjectileVFX;
	WakeVFXAsset = PresentationSettings->ShadowBoltWakeVFX;
	ImpactNiagaraVFXAsset = PresentationSettings->ShadowBoltImpactVFX;
	SecondaryImpactVFXAsset = PresentationSettings->ShadowBoltSecondaryImpactVFX;
	FlySFXAsset = PresentationSettings->ShadowBoltFlightSFX;
	ImpactSFXAsset = PresentationSettings->ShadowBoltImpactSFX;
}
