...
#include "GameDBA/Gameplay/Abilities/Projectiles/DBAFrostShardProjectile.h"
#include "GameDBA/Presentation/VFX/DBAProjectilePresentationDeveloperSettings.h"
...
ADBAFrostShardProjectile::ADBAFrostShardProjectile()
{
	...
	TSoftObjectPtr<UStaticMesh> ConeMeshRef(FSoftObjectPath(TEXT("/Engine/BasicShapes/Cone.Cone")));
	UStaticMesh* ConeMesh = ConeMeshRef.Get();
	...
	const UDBAProjectilePresentationDeveloperSettings* PresentationSettings = GetDefault<UDBAProjectilePresentationDeveloperSettings>();
	ProjectileNiagaraVFXAsset = PresentationSettings->FrostShardProjectileVFX;
	CrystalWakeVFXAsset = PresentationSettings->FrostShardCrystalWakeVFX;
	MistWakeVFXAsset = PresentationSettings->FrostShardMistWakeVFX;
	SpiralWakeVFXAsset = PresentationSettings->FrostShardSpiralWakeVFX;
	ImpactNiagaraVFXAsset = PresentationSettings->FrostShardImpactVFX;
	SecondaryImpactVFXAsset = PresentationSettings->FrostShardSecondaryImpactVFX;
	RingImpactVFXAsset = PresentationSettings->FrostShardRingImpactVFX;
	FlySFXAsset = PresentationSettings->FrostShardFlightSFX;
	ImpactSFXAsset = PresentationSettings->FrostShardImpactSFX;
}
