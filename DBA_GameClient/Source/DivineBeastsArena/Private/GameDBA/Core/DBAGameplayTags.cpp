...
{
	FDBAGameplayTags& TagsToInit = const_cast<FDBAGameplayTags&>(FDBAGameplayTags::Get());
	...
	TagsToInit.GameplayCue_DBA_Skill_Cast = AddTag(
		TEXT("GameplayCue.DBA.Skill.Cast"),
		TEXT("Skill casting gameplay cue"));

	TagsToInit.GameplayCue_DBA_Skill_Projectile = AddTag(
		TEXT("GameplayCue.DBA.Skill.Projectile"),
		TEXT("Skill projectile gameplay cue"));

	TagsToInit.GameplayCue_DBA_Skill_Impact = AddTag(
		TEXT("GameplayCue.DBA.Skill.Impact"),
		TEXT("Skill impact gameplay cue"));

	TagsToInit.GameplayCue_DBA_Skill_AOE = AddTag(
		TEXT("GameplayCue.DBA.Skill.AOE"),
		TEXT("Skill area gameplay cue"));

	TagsToInit.GameplayCue_DBA_Skill_Channel = AddTag(
		TEXT("GameplayCue.DBA.Skill.Channel"),
		TEXT("Skill channel gameplay cue"));
