...
#include "GameDBA/Presentation/VFX/Feedback/DBAEffectPlayer.h"

#include "Camera/PlayerCameraManager.h"
#include "GameDBA/Presentation/VFX/DBANiagaraSkillParameters.h"
#include "GameDBA/Presentation/VFX/Feedback/DBAEffectTableManager.h"
...
void UDBAEffectPlayer::OnSubsystemInitialize()
{
	// P1-1 改造：项目基类统一调用 Super::Initialize，此处仅执行派生类初始化
	CachedWorld = GetWorld();
}

void UDBAEffectPlayer::OnSubsystemDeinitialize()
{
