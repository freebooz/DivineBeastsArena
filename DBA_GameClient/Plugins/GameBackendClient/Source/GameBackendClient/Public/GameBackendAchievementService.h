...
#include "GameBackendAchievementService.generated.h"

class UDBA_GameBackendClientSubsystem;
class FDBA_GameBackendHttpClient;

UCLASS(BlueprintType)
class GAMEBACKENDCLIENT_API UDBA_GameBackendAchievementService : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "DBA_GameBackend|Achievement")
	void GetAchievements(const FDBA_GameBackendResponseDelegate& Callback);
