...
using DBA_GameAdmin.Components;
...
builder.Services.AddScoped<DBA_GameAdmin.Services.AdminAuthState>();
builder.Services.AddHttpClient<DBA_GameAdmin.Services.ApiClient>(client =>
{
